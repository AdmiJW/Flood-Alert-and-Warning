...
public class FileUtil {
    ...
    // Store a file
    public static Path store(MultipartFile file, String directory) throws IOException {
        try {
            Path destinationDirectory = rootLocation
    ...
    public static Stream<Path> loadAll(String directory) throws IOException {
        try {
            Path destinationDirectory = rootLocation
                .resolve( Paths.get( directory ) )
                .normalize()
    ...
    public static Path loadFilePath(String[] paths) {
    ...
    public static Resource loadAsResource(String filename, String directory) throws IOException {
        try {
    ...
    public static void delete(String filename, String directory) throws IOException {
        try {
            Path file = loadFilePath( new String[]{ directory, filename } );
            Files.delete(file);
        }
    ...
    public static void init() throws IOException {
        try {
            deleteAll();
            System.out.println("> Upload directory cleared");
